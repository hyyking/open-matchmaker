...
class MatchMakerTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.mm = MatchMaker(Config(), cls.db)
    ...
    def test_queue(self):
        ...
        self.mm.qctx.queue = []
        assert self.mm.queue_team(self.t1)
    ...
    def test_dequeue(self):
        ...
        assert self.mm.dequeue_team(self.t1)
        assert self.mm.dequeue_team(self.t2)
    ...
    def test_dequeue_not_queued(self):
        ...
        assert not self.mm.dequeue_team(self.t3)
        assert self.mm.has_queued_team(self.t1)
        assert self.mm.has_queued_team(self.t2)
